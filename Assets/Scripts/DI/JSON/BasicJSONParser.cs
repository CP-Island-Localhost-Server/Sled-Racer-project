...
namespace DI.JSON
{
	public class BasicJSONParser : IJSONParser
	{
		...
		protected static bool SerializeValue(object value, StringBuilder builder)
		{
			...
			{
				result = SerializeObject((Dictionary<string, object>)value, builder);
			}
		...
		public bool Parse(string document)
		{
			bool success = false;
			parsed = JsonDecode(document, ref success);
			return success;
		}
		...
		{
			return "BasicJSONParser v1.00.0000";
		}
	}
}
