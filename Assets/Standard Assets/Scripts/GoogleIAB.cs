...
public class GoogleIAB
{
	...
	public static void enableLogging(bool shouldEnable)
	{
		if (Application.platform == RuntimePlatform.Android)
		{
			if (shouldEnable)
			{
				UnityEngine.Debug.LogWarning("YOU HAVE ENABLED HIGH DETAIL LOGS. DO NOT DISTRIBUTE THE GENERATED APK PUBLICLY. IT WILL DUMP SENSITIVE INFORMATION TO THE CONSOLE!");
			}
	...
	public static void queryInventory(string[] skus)
	{
		if (Application.platform == RuntimePlatform.Android)
		{
			_plugin.Call("queryInventory", new object[1]
			{
				skus
			});
		}
	...
	public static void consumeProducts(string[] skus)
	{
		if (Application.platform == RuntimePlatform.Android)
		{
			_plugin.Call("consumeProducts", new object[1]
			{
				skus
			});
		}
