...
public class EtceteraUIManagerTwo : MonoBehaviourGUI
{
	...
	private void OnGUI()
	{
		...
		if (GUILayout.Button("Schedule Notification in 5 Seconds"))
		{
			...
			UnityEngine.Debug.Log("notificationId: " + _fiveSecondNotificationId);
		}
		if (GUILayout.Button("Schedule Notification in 10 Seconds"))
		{
			...
			UnityEngine.Debug.Log("notificationId: " + _tenSecondNotificationId);
		}
		...
		{
			UnityEngine.SceneManagement.SceneManager.LoadScene("EtceteraTestScene");
		}
	}
}
